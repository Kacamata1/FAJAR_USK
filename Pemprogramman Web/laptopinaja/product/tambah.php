...
<head>
    ...
    <title>LaptopInAja | Add Laptop In All Here</title>
...
<body>
    ...
    <?php 
        ...
        $query = mysqli_query($koneksi, "INSERT INTO laptop_tb (nama_laptop,harga_laptop,spesifikasi_laptop, gambar_laptop) VALUES('$nama' , '$harga' , '$spesifikasi' , '$namaFile')");
